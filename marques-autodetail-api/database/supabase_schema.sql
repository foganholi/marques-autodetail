...
create table if not exists empresas (
    ...
    usuario_id bigint,
    endereco_id bigint,
    constraint fk_empresas_usuario foreign key (usuario_id) references usuarios(id) on delete set null,
...
create table if not exists agendamentos (
    ...
    constraint fk_agendamentos_servico foreign key (servico_id) references servicos(id) on delete set null,
...
create table if not exists avaliacoes (
    ...
    constraint fk_avaliacoes_cliente foreign key (cliente_id) references usuarios(id) on delete set null,
    constraint fk_avaliacoes_empresa foreign key (empresa_id) references empresas(id) on delete cascade,
    constraint fk_avaliacoes_agendamento foreign key (agendamento_id) references agendamentos(id) on delete set null,
